...
export default {
  setup() {
    ...
    onMounted(async () => {
      try {
        const scanner = await (pScanner.value = DBR.BarcodeScanner.createInstance());
        scanner.setUIElement(document.querySelector('.component-barcode-scanner'));
