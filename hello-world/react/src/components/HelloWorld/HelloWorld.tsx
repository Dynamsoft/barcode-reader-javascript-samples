    ...
    render() {
        return (
            <div className="div-hello-world">
                ...
                <div>
                    <button style={{ marginRight: '10px', backgroundColor: this.state.bShowVideoCapture ? 'rgb(255,174,55)' : 'white' }} onClick={this.showVideoCapture}>Decode Video</button>
                    <button style={{ backgroundColor: this.state.bShowImageCapture ? 'rgb(255,174,55)' : 'white' }} onClick={this.showImageCapture}>Decode Image</button>
                </div>
