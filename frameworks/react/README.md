...
In this guide, we will be using [`dynamsoft-barcode-reader-bundle 11.6.3200](https://www.npmjs.com/package/dynamsoft-barcode-reader-bundle/v/11.6.3200).
...
* <a target = "_blank" href="https://github.com/Dynamsoft/barcode-reader-javascript-samples/tree/main/frameworks/react">Hello World in React with Hooks - Source Code</a>
 ...
 * For more information, see https://www.dynamsoft.com/barcode-reader/docs/web/programming/javascript/user-guide/index.html?ver=11.6.3200&cVer=true#specify-the-license&utm_source=samples or contact support@dynamsoft.com.
